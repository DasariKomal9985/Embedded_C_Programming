...
void MAX30102_Init(I2C_HandleTypeDef *hi2c) {
    MAX30102_WriteReg(hi2c, REG_INTR_ENABLE_1, 0xC0);     // A_FULL and PPG Ready
    ...
    MAX30102_WriteReg(hi2c, REG_MODE_CONFIG, 0x03);       // SpO2 mode
    MAX30102_WriteReg(hi2c, REG_SPO2_CONFIG, 0x27);       // 100 Hz, 411us, 16-bit ADC
    MAX30102_WriteReg(hi2c, REG_LED1_PA, 0x24);           // RED LED 7.6 mA
    MAX30102_WriteReg(hi2c, REG_LED2_PA, 0x24);           // IR LED 7.6 mA
}
