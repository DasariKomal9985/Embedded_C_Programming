...
#define DAC_AMP      2000u   // Keep below 2047 to avoid clipping (12-bit DAC)
#define DAC_ALIGN    DAC_ALIGN_12B_R
#define TIM2_PSC     0u
#define TIM2_ARR     61u

static uint16_t g_sine[TABLE_SIZE];
...
// IRQ handler; ensure this is linked in your vector table
