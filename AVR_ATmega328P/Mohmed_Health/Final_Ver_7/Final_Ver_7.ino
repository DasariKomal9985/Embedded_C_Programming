...
// 📡 LoRa Pins and Frequency (for ESP32, adjust as needed)
#define LORA_SS 5
#define LORA_RST 14
#define LORA_DIO0 2
#define LORA_BAND 915E6   // Frequency (US: 915E6, EU: 868E6)
...
void setup() {
  ...
  // ---------- Initialize LoRa ----------
  SPI.begin(18, 19, 23, LORA_SS); // SCK, MISO, MOSI, SS (adjust pins if needed)
